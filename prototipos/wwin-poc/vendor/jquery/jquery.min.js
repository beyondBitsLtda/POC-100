...
(function (global) {
  ...
  Wrapper.prototype.on = function (events, handler) {
    var eventList = events.split(/\s+/).filter(Boolean);
  ...
  Wrapper.prototype.removeData = function (key) {
    return this.each(function () {
      if (this.dataset && this.dataset[key] !== undefined) {
